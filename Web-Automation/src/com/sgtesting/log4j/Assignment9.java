...
public class Assignment9 {
	...
	static void User1()
	{
		try
		{
			log.info("The user1 created successfully");
	...
	static void logout()
	{
		try
		{
			log.info("The logout successfully");
	...
	static void User1Loging()
	{
		try
		{
			log.info("The user1login successfully");
	...
	static void Admin1login()
	{
		try
		{
			log.info("The admin1login successfully");
			oBrowser.findElement(By.id("username")).sendKeys("admin");
			oBrowser.findElement(By.name("pwd")).sendKeys("manager");
			oBrowser.findElement(By.xpath("//*[@id='loginButton']/div")).click();
			Thread.sleep(2000);
	...
	static void ModifyUser1() {
		try 
		{
			log.info("The modifyuser1 successfully");
			oBrowser.findElement(By.xpath("//*[@id='topnav']/tbody/tr[1]/td[5]/a/div[2]")).click();
			Thread.sleep(2000);
	...
	static void Admin1logout()
	{
		try
		{
			log.info("The admin1logout successfully");
			oBrowser.findElement(By.linkText("Logout")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
	...
	static void User1LogingAgain()
	{
		try
		{
			log.info("The user1loginagain successfully");
	...
	static void ModifyUser2() {
		try 
		{
			log.info("The modifyuser2 successfully");
			oBrowser.findElement(By.xpath("//*[@id='topnav']/tbody/tr[1]/td[5]/a/div[2]")).click();
			Thread.sleep(2000);
	...
	static void User1logoutAgain()
	{
		try
		{
			log.info("The user1logoutagain successfully");
			oBrowser.findElement(By.linkText("Logout")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
	...
	static void User2LogingAgain()
	{
		try
		{
			log.info("The user2loginagain successfully");
	...
	static void ModifyUser3() {
		try 
		{
			log.info("The modifyuser3 successfully");
			oBrowser.findElement(By.xpath("//*[@id='topnav']/tbody/tr[1]/td[5]/a/div[2]")).click();
			Thread.sleep(2000);
	...
	static void User2LogoutAgain()
	{
		try
		{
			log.info("The user2logoutagain successfully");
			oBrowser.findElement(By.linkText("Logout")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
	...
	static void User1logoutAgainAgain()
	{
		try
		{
			log.info("The user1logoutagainagain successfully");
			oBrowser.findElement(By.linkText("Logout")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
	...
	static void Admin1loginAgain()
	{
		try
		{
			log.info("The admin1loginagain successfully");
			oBrowser.findElement(By.id("username")).sendKeys("admin");
			oBrowser.findElement(By.name("pwd")).sendKeys("manager");
			oBrowser.findElement(By.xpath("//*[@id='loginButton']/div")).click();
			Thread.sleep(2000);
	...
	static void Admin1logoutAgainAgain()
	{
		try
		{
			log.info("The adminlogoutagainagain successfully");
			oBrowser.findElement(By.linkText("Logout")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
